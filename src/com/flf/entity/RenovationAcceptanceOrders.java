 ...
 * 2015/08/19
 */
@XmlRootElement(name = "RenovationAcceptanceOrders")
public class RenovationAcceptanceOrders {
	private String orderId;   //装修验收工单id
	...
	private List<RenovationAcceptanceRecords> renovationAcceptanceRecords;
	...
	public List<RenovationAcceptanceRecords> getRenovationAcceptanceRecords() {
		return renovationAcceptanceRecords;
	}
	public void setRenovationAcceptanceRecords(
			List<RenovationAcceptanceRecords> renovationAcceptanceRecords) {
		this.renovationAcceptanceRecords = renovationAcceptanceRecords;
	}
}
