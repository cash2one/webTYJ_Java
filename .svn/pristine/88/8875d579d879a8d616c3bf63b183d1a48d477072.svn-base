...
public class MenuController {
	...
	public String toEdit(@RequestParam String menuId,Model model){
	...
	public void getSub(@RequestParam String menuId,HttpServletResponse response){
	...
	public void delete(@RequestParam String menuId,PrintWriter out){
