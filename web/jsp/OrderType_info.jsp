...
<body>
	<form action="/Home/OrderType/AddOrUpdateOrderType.do" name="OrderTypeForm" id="OrderTypeForm" target="result" method="post">
	<table border="0" cellpadding="0" cellspacing="0">
		<tr class="info">
			<th>类型名称：</th>
			<td>
				<input type="text" name="orderTypeType" value="${OrderType.orderTypeType}"/>
				<input type="hidden" name="orderTypeId" value="${OrderType.orderTypeId}">
			</td>
		</tr>
		</table>
	</form>
