...
public interface StoreNewMapper {
	 ...
	 * @return
	 */
	List<StoreNew> listPageStoreByBuildingStructureId(StoreNew storeNew);
	/**
	 * 根据建筑结构ID获取建筑面积
	 * @author maogaofei
	 * @date 2016年7月28日 下午4:52:33
	 * @param buildingId
	 * @return
	 */
	Double getBuildingAreaByBuildingStructureId(String buildingId);
}
