...
public interface BuildingStructureNewMapper {
    ...
    List<BuildingStructureNew> listPrivateStall(String custId);
    /**
     * 根据房屋全名查询房屋信息     尹磊
     * @param fullName
     * @return
  ...
  //根据parentId获取住宅建筑结构信息
	 ...
	 * 查询车位父级
	 * @author hanyupeng
	 * date 2016年7月13日16:52:57
	 * @return
	 */
	List<BuildingStructureNew> getBuildingParentListByType();
	/**
	 * 查询车位父级的父级
	 * @author hanyupeng
	 * date 2016年7月13日16:52:57
	 * @return
	 */
	List<BuildingStructureNew> getBuildingParentTopListByType();
	/**
	 * @author hanyupeng
	 * date 2016年7月18日11:03:53
	 * @return
	 */
	List<BuildingStructureNew> getBuildingListByTypeOrId(String id);
	List<BuildingStructureNew> getBuildingParentListByTypeOrId(String id);
	List<BuildingStructureNew> getBuildingParentTopListByTypeOrId(String id);
	List<BuildingStructureNew> getBuildingListById(String id);
	
	//查找车位
	List<BuildingStructureNew> getProductBsType();
	//查找层
	List<BuildingStructureNew> getProductBsParent();
	//查找栋
	List<BuildingStructureNew> getProductBsParentTop();
	
	//查找已经选定车位
	List<BuildingStructureNew> getByProductId(String productid);
	//查找已经选定层
	List<BuildingStructureNew> getParentByProductId(String productId);
	//查找已经选定栋
	List<BuildingStructureNew> getParentTopByProductId(String productId);
	//编辑时查找层
	List<BuildingStructureNew> editParentByProductId(String productId);
	//编辑时查找栋
	List<BuildingStructureNew> editParentTopByProductId(String productId);
	//编辑时查找车位
	List<BuildingStructureNew> editByProductId(String productId);
	
	//根据单个fullName和parcelId查询房屋信息
	List<BuildingStructureNew>  getBuildingStructureNewByFullNameAndParcelId(String fullName,String parcelId); 
}