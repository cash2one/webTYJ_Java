...
public class WaterMeterServiceImpl implements WaterMeterService {
	 ...
	 */
	@Override
	public Info insertWaterMeterrest(WaterMeter waterMeter) {
		// TODO Auto-generated method stub
		WaterMeter waterNum1 = meterMapper.getWaterMeterbyWaterMeterNum(waterMeter.getWaterMeterNum());
		//WaterMeter waterNum2 = meterMapper.getWaterMeterbyPropertyNumber(waterMeter.getProperty().getPropertyNumber());
		if (waterNum1!=null) {
			return Tools.msg("新建失败，水表编号已存在！", false);
		}
		/*
		else if (waterNum2!=null) {
	 ...
	 */
	@Override
	public Info updateWaterMeterrest(WaterMeter waterMeter) {
		// TODO Auto-generated method stub
		WaterMeter waterNum1 = meterMapper.getWaterMeterbyWaterMeterNum(waterMeter.getWaterMeterNum());
		//WaterMeter waterNum2 = meterMapper.getWaterMeterbyPropertyNumber(waterMeter.getProperty().getPropertyNumber());
		if (waterNum1!=null) {
			return Tools.msg("编辑失败，水表编号已存在！", false);
		}
		/*
		else if (waterNum2!=null) {
			Tools.msg("资产编号已存在", false);
