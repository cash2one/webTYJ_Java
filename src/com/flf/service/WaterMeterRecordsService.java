...
public interface WaterMeterRecordsService {
	...
	*/
	 ...
	 */
	@GET
	@Path("/getWaterMeterRecordsbyBuildigId/{buldingId}")
	@Produces(MediaType.APPLICATION_JSON)
	WaterMeterRecords getWaterMeterRecordsbybuildigId(@PathParam("buldingId") String buldingId);
  ...
  InputStream exportMeterRecords();
	 ...
	 */
	@POST
	@Path("/listWaterMeterRecordsByProjectIdAndBuildingStructureId")
	@Produces(MediaType.APPLICATION_JSON)
