...
public class MeterReadingOrders {
	...
	private List<MeterReadingRecords> meterReadingRecords;//电表工单记录信息
	...
	public List<MeterReadingRecords> getMeterReadingRecords() {
		return meterReadingRecords;
	}
	public void setMeterReadingRecords(List<MeterReadingRecords> meterReadingRecords) {
