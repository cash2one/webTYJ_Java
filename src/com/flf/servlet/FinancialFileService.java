 ...
 * 回盘文件上传工具类
 * @author maogaofei
 * @date 2016年6月7日 上午10:11:55
 */
public class FinancialFileService extends HttpServlet{
        ...
        try {  
            ...
            {  
                ...
                if (!item.isFormField()) {  
                    ...
                    String newFileName = df.format(new Date()) + "_" + new Random().nextInt(1000) +"_"+fileHeadName+"." + fileExt;  
                    try{  
