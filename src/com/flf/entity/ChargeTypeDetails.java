 ...
 * 收费类型详情
 * @author maogaofei
 * @date 2016年6月29日 下午4:33:10
 */
@XmlRootElement(name = "ChargeTypeDetails")
public class ChargeTypeDetails {
    ...
    public void setChargeTypeDetailsName(String chargeTypeDetailsName) {
        this.chargeTypeDetailsName = chargeTypeDetailsName == null ? null : chargeTypeDetailsName.trim();
    }
    ...
    public void setChargeTypeDetailsNum(String chargeTypeDetailsNum) {
        this.chargeTypeDetailsNum = chargeTypeDetailsNum == null ? null : chargeTypeDetailsNum.trim();
    }
