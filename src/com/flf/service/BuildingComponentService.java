...
public interface BuildingComponentService {
	 ...
	 */
	@GET
	@Path("/getBuildingComponentBybuildingStructureId/{buildingStructureId}")
	@Produces(MediaType.APPLICATION_JSON)
	List<BuildingComponent> getBuildingComponentBybuildingStructureId(@PathParam("buildingStructureId") String buildingStructureId);
}
