...
public interface AccountRecordService {
	 ...
	 */
	@GET
	@Path("/queryByFsid/{financialStaffId}/{projectId}")
	@Produces(MediaType.APPLICATION_JSON)
	AccountRecord queryByFsid(@PathParam("financialStaffId") String financialStaffId, @PathParam("projectId") String projectId);
	...
	@Path("/listPageByPost")
	@Produces(MediaType.APPLICATION_JSON)
	PageRestful listPageByPost(AccountRecord accountRecord);
}
