...
@XmlRootElement(name = "WaterMeterRecords") // 水表使用记录表
public class WaterMeterRecords {
    ...
    private String usingNature;  //使用性质  0.商业 1.居民 2.管理处

    private String waterMeterBuildingId;  //水表所有人类型id

    private String assetsId;  //资产id

    private Integer state; // 表状态  0.  1.新建 2.使用中 3.停用 4.未使用

    private String readingWay;  //抄表方式  1.户内 2.户外 3.远程抄表
    ...
    private WaterMeter waterMeter; // 水表表
    ...
    private String waterMeterDescribed; //表描述
    ...
    private Double childMeterReading;//字表读数总和
    
    private Double childConsumption;//公共水表用量总和
    
    private Date queryDate; //水损查询日期
    
    private List<String> parentNumList; //水损查询，父表编号集合
    ...
    private String lossRate;//水损率
    
    private Double waterLoss;//水损
    
    private Double bootChildConsumption;//底层子级水表用量

    private Double consumption;//父表用水量
    
    private String waterName;//水表描述
    
    private String specifiedDate ; //抄表日期
    ...
    public String getWaterMeterBuildingId() {
        return waterMeterBuildingId;
    }

    public void setWaterMeterBuildingId(String waterMeterBuildingId) {
        this.waterMeterBuildingId = waterMeterBuildingId;
    }
