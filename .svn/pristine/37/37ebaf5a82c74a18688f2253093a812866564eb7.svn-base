...
public class CalculatorUtils{
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("表达式3：(\"(" + a + "+" + b + ") * (" + a + "-" + b
                + ")\") = " + calculator.analysis(express3));
        String express4 = "2.0*6-7/2";
        System.out.println("表达式4：(\"2.07*6-7/2\") = " + calculator.analysis(express4));
        String express5 = "(8-3)*((a+b)/(a-b))";
        System.out.println("表达式5：(\"(8-3)*((" + a + "+" + "+" + b + ")/(" + a
                + "-" + b + "))\") = " + calculator.analysis(express5));
        String express6 = "13 % 2";
        System.out.println("表达式6：(\"13%2\") = " + calculator.analysis(express6));
        String express7 = "4^3 * 8 + 2";
        System.out
                .println("表达式7：\"3^2 * 5 + 4\") = " + calculator.analysis(express7));
