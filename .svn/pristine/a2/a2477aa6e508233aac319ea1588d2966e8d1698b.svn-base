...
public class ElectricityMeterServiceImpl implements ElectricityMeterService {
	...
	//新增电表信息
	@Override
	public Info insertElectricityMeterrest(ElectricityMeter electricityMeter) {
		// TODO Auto-generated method stub
		ElectricityMeter electricityNum1 = electricityMeterMapper.getElectricityMeterbyElectricityMeterNum(electricityMeter.getElectricityMeterNum());
		//ElectricityMeter electricityNum2 = electricityMeterMapper.getElectricityMeterbyPropertyNumber(electricityMeter.getProperty().getPropertyNumber());
		if (electricityNum1!=null) {
			return Tools.msg("新建失败，电表编号已存在！", false);
		}
		/*
		else if (electricity2!=null) {
			Tools.msg("资产编号已存在", false);
		}*/
		else{
			...
			return Tools.msg("电表新建成功！", true);
		}
	}

	@Override
	public Info updateElectricityMeter(ElectricityMeter electricityMeter) {
		// TODO Auto-generated method stub
		ElectricityMeter electricityNum1 = electricityMeterMapper.getElectricityMeterbyElectricityMeterNum(electricityMeter.getElectricityMeterNum());
		//ElectricityMeter electricityNum2 = electricityMeterMapper.getElectricityMeterbyPropertyNumber(electricityMeter.getProperty().getPropertyNumber());
		if (electricityNum1!=null) {
