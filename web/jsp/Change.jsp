...
<body>
	<form action="/Home/Change/AddChange.do" name="ChangeForm" id="ChangeForm" target="result" method="post">
	<table border="0" cellpadding="0" cellspacing="0">
		...
		<tr class="info">
			<th>负责人:</th>
			<td><input type="text" name="owner" value="${order.owner}" class="input_txt"/></td>
		</tr>
