...
public interface PaymsService {
   ...
   // ElectronicBilling listElectronicBillingByHouseIdAndCustId(String houseId, String custId);
     ...
     * @date 2016.05.03
     */
    AdvancePaymentsDetails getPaymentDetailsByPaymentDetailsId(String advancePaymentsDetailsId);
	...
	/**
	 * 支付系统 资产明细查询 物业费查询 得到计费详情Id
	 * @param map
	 * @return
	 */
	List<Formula> getChargeItemDetailId(String buildingId,String projectId,String courrentTime,String btjj);
	/**
	 * 支付系统 根据计费详情Id 查询本金 物业费信息 
	 * @param chargeItemDetailsId
	 * @return
	 */
	List<Formula>getFormularInfo(String chargeItemDetailsId);
	 ...
	 * @param money
	 */
	void crossOfAccount(String buildingId, String chargeTypeId, Double money);
}
