...
define(['tyjApp'],function(module){
    module.controller("verificationCtrl",function($scope,$http,Paginator,$rootScope){
        $scope.tmpList=['top-check','top-checkFinish','top-addCheck'];
        $scope.currentTemplate = "top-check";
