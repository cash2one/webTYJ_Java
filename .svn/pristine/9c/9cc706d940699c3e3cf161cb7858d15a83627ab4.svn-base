...
<body>
	<form action="/Home/Division/AddOrUpdateDivision.do" name="DivisionForm" id="DivisionForm" target="result" method="post">
	<table border="0" cellpadding="0" cellspacing="0">
		<tr class="info">
			<th>部门名称:</th>
			<td>
			<input type="hidden" name="id" id="DivisionId" value="${Division.id}"/>
			<input type="text" name="divisionName" class="input_txt" value="${Division.divisionName }"/></td>
		</tr>
