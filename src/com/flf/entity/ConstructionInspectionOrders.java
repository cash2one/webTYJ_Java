 ...
 *	2015-9-1
 */
@XmlRootElement(name="ConstructionInspectionOrders")
public class ConstructionInspectionOrders {
	...
	private List<ConstructionInspectionRecords> constructionInspectionRecords;//巡检工单记录表
	...
	public List<ConstructionInspectionRecords> getConstructionInspectionRecords() {
		return constructionInspectionRecords;
	}
	public void setConstructionInspectionRecords(
			List<ConstructionInspectionRecords> constructionInspectionRecords) {
		this.constructionInspectionRecords = constructionInspectionRecords;
	}
}
