...
//	public void insertServiceRequestRestful(ServiceRequest serviceRequest ,Tasks tasks);
	 ...
	 */
	@GET
	@Path("/getInspectionServiceRequest")
	@Produces(MediaType.APPLICATION_JSON)
	List<ServiceRequest> getInspectionServiceRequest();
	 ...
	 */
	@POST
	@Path("/listPageInspectionServiceRequestbyStateAndType")
	@Produces(MediaType.APPLICATION_JSON)
	PageRestful listPageInspectionServiceRequestbyStateAndType(ServiceRequest serviceRequest);
	 ...
	 */
	@POST
	@Path("/listPageInspectionServiceRequestbyStateAndType1")
	@Produces(MediaType.APPLICATION_JSON)
	PageRestful listPageInspectionServiceRequestbyStateAndType1(ServiceRequest serviceRequest);
