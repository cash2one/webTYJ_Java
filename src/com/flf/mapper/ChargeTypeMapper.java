...
public interface ChargeTypeMapper {
	...
	//获取优先级
	List<ChargeType> getPriority(String productId);
	
	//通过名字查找
	ChargeType selectByName(String name, String id, String projectId);
	//获取编号
	ChargeType getCode();
	
	ChargeType selectStateById(String chargeTypeId);
	
	ChargeType selectByName2(String name, String projectId);
