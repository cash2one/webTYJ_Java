...
public interface CommuntitnoticeService {
	...
	@GET
	@Path("/listAllsCommuntitnotice")
	@Produces(MediaType.APPLICATION_JSON)
	List<Communtitnotice> listAllsCommuntitnotice(); 
	
	@GET
	@Path("/listAllsCommuntitnoticeByUserId/{userId}")
	@Produces(MediaType.APPLICATION_JSON)
	List<Communtitnotice> listAllsCommuntitnoticeByUserId(@PathParam("userId") String userId); 
